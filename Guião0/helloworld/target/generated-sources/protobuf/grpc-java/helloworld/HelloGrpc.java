...
public final class HelloGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<helloworld.ByeRequest,
      helloworld.ByeReply> getByeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "bye",
      requestType = helloworld.ByeRequest.class,
      responseType = helloworld.ByeReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<helloworld.ByeRequest,
      helloworld.ByeReply> getByeMethod() {
    io.grpc.MethodDescriptor<helloworld.ByeRequest, helloworld.ByeReply> getByeMethod;
    if ((getByeMethod = HelloGrpc.getByeMethod) == null) {
      synchronized (HelloGrpc.class) {
        if ((getByeMethod = HelloGrpc.getByeMethod) == null) {
          HelloGrpc.getByeMethod = getByeMethod =
              io.grpc.MethodDescriptor.<helloworld.ByeRequest, helloworld.ByeReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "bye"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  helloworld.ByeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  helloworld.ByeReply.getDefaultInstance()))
              .setSchemaDescriptor(new HelloMethodDescriptorSupplier("bye"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void bye(helloworld.ByeRequest request,
        io.grpc.stub.StreamObserver<helloworld.ByeReply> responseObserver) {
  ...
  public static final class HelloStub
    ...
    /**
     */
    public void bye(helloworld.ByeRequest request,
        io.grpc.stub.StreamObserver<helloworld.ByeReply> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
  ...
  public static final class HelloBlockingStub
    ...
    /**
     */
    public helloworld.ByeReply bye(helloworld.ByeRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class HelloFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<helloworld.ByeReply> bye(
        helloworld.ByeRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          ...
          break;
        case METHODID_BYE:
          serviceImpl.bye((helloworld.ByeRequest) request,
              (io.grpc.stub.StreamObserver<helloworld.ByeReply>) responseObserver);
          break;
        default:
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              helloworld.ByeRequest,
              helloworld.ByeReply>(
                service, METHODID_BYE)))
        .build();
  }
